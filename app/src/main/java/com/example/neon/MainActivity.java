...
import com.example.neon.callbacks.MainActionModeCallback;
import com.example.neon.callbacks.NoteEventListener;
import com.example.neon.data.model.Note;
import com.example.neon.db.NotesDB;
import com.example.neon.db.NotesDao;
...
import static com.example.neon.EditNoteActivity.NOTE_EXTRA_Key;
...
//         init recyclerView
    ...
    private void setupNavigation(Bundle savedInstanceState, Toolbar toolbar) {
        ...
        SwitchDrawerItem switchDrawerItem = new SwitchDrawerItem()
                .withName("Dark Theme")
                .withChecked(theme == R.style.AppTheme2_Dark)
                ...
                .withOnCheckedChangeListener(new OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(IDrawerItem drawerItem, CompoundButton buttonView, boolean isChecked) {
                        ...
                        if (isChecked) {
                            settings.edit().putInt(THEME_Key, R.style.AppTheme2_Dark).apply();
                        } else {
